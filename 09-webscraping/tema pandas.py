...
total = [y for x in [valori_lista, valori_lista1] for y in x]
for i in data_set.index:
 valori_dataset = data_set.loc[i, 0]
 valori_lista.append(valori_dataset)

for i in data_set.index:
 valori_dataset = data_set.loc[i, 1]
 valori_lista1.append(valori_dataset)
print(total)
print(valori_lista1)
print(valori_lista)


descript = pd.DataFrame(description, index=["linia1", "linia2"])
valori_descript = descript.loc["linia2"]
valori_country = descript.loc["linia1"]
descript_lista = []
for i in valori_country:
  descript_lista.append(i)
for i in valori_descript:
  descript_lista.append(i)
